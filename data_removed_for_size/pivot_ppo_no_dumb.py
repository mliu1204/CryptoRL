"""
This is LSTM future prediction + MLP PPO environment V2  (final version)
...
class PPOEnv(gymnasium.Env):
    ...
    def __init__(self, data_file_name, quantity_to_buy_sol = 1):
        ...
        self.quantity_to_buy_sol = quantity_to_buy_sol
    ...
    def step(self, action: int):
        ...
        new_portfolio_value = self.coins_held *  self.current_obs[ObsIdx.PRICE]/ObsScaling.PRICE + self.net_solana
...
# CUSTOM HELPER FUNCTIONS
    ...
    def buy(self):
        if self.coins_held != 0:
            ...
            actual_price = self.current_obs[ObsIdx.PRICE]/ObsScaling.PRICE
            shit_coins_to_buy = self.quantity_to_buy_sol/actual_price
            self.coins_held += shit_coins_to_buy
            spent_solana = self.quantity_to_buy_sol
    ...
    def sell(self):
        if self.coins_held == 0:
            ...
            actual_price = self.current_obs[ObsIdx.PRICE]/ObsScaling.PRICE
            earned_solana = self.coins_held * actual_price
